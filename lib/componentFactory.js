...
module.exports = function(element) {
  ...
  switch (element[0].name) {
    ...
    case this.components.hLine:
       ...
       return format('<table class="%s" role="presentation"><tr><th>&nbsp;</th></tr></table>', classes.join(' '))
    ...
    case this.components.row:
      ...
      return format('<table %s class="%s" role="presentation"><tbody><tr>%s</tr></tbody></table>', attrs, classes.join(' '), inner);
    ...
    case this.components.button:
      ...
      return format('<table class="%s" role="presentation"><tbody><tr><td><table role="presentation"><tbody><tr><td>%s</td></tr></tbody></table></td>%s</tr></tbody></table>', classes.join(' '), inner, expander);
    ...
    case this.components.container:
      ...
      return format('<table %s align="center" class="%s" role="presentation"><tbody><tr><td>%s</td></tr></tbody></table>', attrs, classes.join(' '), inner);
    ...
    case this.components.menu:
      ...
      return format('<table %s class="%s" role="presentation"><tbody><tr><td><table role="presentation"><tbody><tr>%s</tr></tbody></table></td></tr></tbody></table>', attrs, classes.join(' '), inner);
    ...
    case this.components.callout:
      ...
      return format('<table %s class="callout" role="presentation"><tbody><tr><th class="%s">%s</th><th class="expander"></th></tr></tbody></table>', attrs, classes.join(' '), inner);
    ...
    case this.components.spacer:
      ...
      if (element.attr('size-sm') || element.attr('size-lg')) {
        if (element.attr('size-sm')) {
          ...
          html += format('<table %s class="%s hide-for-large" role="presentation"><tbody><tr><td height="'+size+'px" style="font-size:'+size+'px;line-height:'+size+'px;">&nbsp;</td></tr></tbody></table>', attrs);
        }
        if (element.attr('size-lg')) {
          size = (element.attr('size-lg'));
          html += format('<table %s class="%s show-for-large" role="presentation"><tbody><tr><td height="'+size+'px" style="font-size:'+size+'px;line-height:'+size+'px;">&nbsp;</td></tr></tbody></table>', attrs);
        }
      } else {
        size = (element.attr('size')) || 16;
        html += format('<table %s class="%s" role="presentation"><tbody><tr><td height="'+size+'px" style="font-size:'+size+'px;line-height:'+size+'px;">&nbsp;</td></tr></tbody></table>', attrs);
      }
    ...
    case this.components.wrapper:
      ...
      return format('<table %s class="%s" align="center" role="presentation"><tbody><tr><td class="wrapper-inner">%s</td></tr></tbody></table>', attrs, classes.join(' '), inner);
